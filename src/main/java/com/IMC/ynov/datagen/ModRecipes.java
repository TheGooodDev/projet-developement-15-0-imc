...
public class ModRecipes extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(Registration.PEAR_DOOR.get())
                ...
                .group("ynov")
                .save(consumer);
        ShapedRecipeBuilder.shaped(Registration.PEAR_PLANKS.get())
                .pattern("#")
                .define('#', Registration.PEAR_LOG.get())
                .group("ynov")
                .save(consumer);


        ShapedRecipeBuilder.shaped(Registration.BANANA_BUTTON.get())
                .pattern("#")
        ...
        ShapedRecipeBuilder.shaped(Registration.BANANA_DOOR.get())
                ...
                .group("ynov")
                .save(consumer);
        ShapedRecipeBuilder.shaped(Registration.BANANA_PLANKS.get())
                .pattern("#")
                .define('#', Registration.BANANA_LOG.get())
                .group("ynov")
                .save(consumer);


        ShapedRecipeBuilder.shaped(Registration.ORANGE_BUTTON.get())
                .pattern("#")
        ...
        ShapedRecipeBuilder.shaped(Registration.ORANGE_DOOR.get())
                ...
                .group("ynov")
                .save(consumer);
        ShapedRecipeBuilder.shaped(Registration.ORANGE_PLANKS.get())
                .pattern("#")
                .define('#', Registration.ORANGE_LOG.get())
                .group("ynov")
                .save(consumer);
