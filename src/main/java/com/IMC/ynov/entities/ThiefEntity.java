...
public class ThiefEntity extends Animal {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new TemptGoal(this,2.0, Ingredient.of(Items.DIAMOND),false));
        this.goalSelector.addGoal(1, new AvoidEntityGoalNoCombat<>(this, Player.class, 6.0F, 1.2, 1.2));
        this.goalSelector.addGoal(2, new ThiefFindChestGoal(this, 1.3));
